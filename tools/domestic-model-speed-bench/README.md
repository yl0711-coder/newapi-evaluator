...
当前内置 Codex 家族包含 GPT-6 Astra、GPT-5.6 Sol、GPT-5.6 Terra；Claude 家族包含 Fable 5、Opus 5、Sonnet 5；同时保留 GLM、Kimi、DeepSeek 测试模型。模型 ID 会随上游变化，若渠道实际名称不同，直接修改两端的“请求模型”即可。国产模型官方端点参考：
