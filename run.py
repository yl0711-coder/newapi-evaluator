...
def main():
    ...
    parser.add_argument("--app", choices=["all", "channels", "admission", "stability", "reasoning", "capacity", "image-quality"], default="all")
    ...
    ports = {"all": 8090, "channels": 8094, "admission": 8091, "stability": 8092, "reasoning": 8093, "capacity": 8095, "image-quality": 8096}
