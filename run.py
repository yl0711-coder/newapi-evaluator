...
def main():
    ...
    parser.add_argument("--app", choices=["all", "channels", "admission", "stability", "reasoning", "capacity", "diagnosis"], default="all")
    ...
    ports = {"all": 8090, "channels": 8094, "admission": 8091, "stability": 8092, "reasoning": 8093, "capacity": 8095, "diagnosis": 8096}
